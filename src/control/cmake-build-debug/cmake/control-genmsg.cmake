...
set(MSG_I_FLAGS "-Icontrol:/home/lucas/Dropbox/ros_reorg/temp_ws/src/control/msg;-Istd_msgs:/opt/ros/indigo/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/lucas/Dropbox/ros_reorg/temp_ws/src/control/msg/behavior.msg" NAME_WE)
add_custom_target(_control_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "control" "/home/lucas/Dropbox/ros_reorg/temp_ws/src/control/msg/behavior.msg" ""
)
...
_generate_msg_cpp(control
  "/home/lucas/Dropbox/ros_reorg/temp_ws/src/control/msg/behavior.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/control)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/control\")")
  # install generated code
  install(
