...
//Node for debugging laser scanners
...
int main(int argc, char** argv) {
    ...
    ros::Subscriber sub_l = nh.subscribe("/iRobot_0/left_side_scan", 1, cb_l);
    ros::Subscriber sub_fl = nh.subscribe("/iRobot_0/left_front_scan", 1, cb_fl);
    ros::Subscriber sub_fr = nh.subscribe("/iRobot_0/right_front_scan", 1, cb_fr);
    ros::Subscriber sub_r = nh.subscribe("/iRobot_0/right_side_scan", 1, cb_r);
