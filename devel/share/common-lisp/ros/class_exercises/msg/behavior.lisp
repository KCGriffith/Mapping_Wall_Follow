...
(cl:in-package class_exercises-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <behavior>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'behavior)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name class_exercises-msg:<behavior> is deprecated: use class_exercises-msg:behavior instead.")))

(cl:ensure-generic-function 'active-val :lambda-list '(m))
(cl:defmethod active-val ((m <behavior>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader class_exercises-msg:active-val is deprecated.  Use class_exercises-msg:active instead.")
  (active m))

(cl:ensure-generic-function 'vel_fw-val :lambda-list '(m))
(cl:defmethod vel_fw-val ((m <behavior>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader class_exercises-msg:vel_fw-val is deprecated.  Use class_exercises-msg:vel_fw instead.")
  (vel_fw m))

(cl:ensure-generic-function 'vel_turn-val :lambda-list '(m))
(cl:defmethod vel_turn-val ((m <behavior>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader class_exercises-msg:vel_turn-val is deprecated.  Use class_exercises-msg:vel_turn instead.")
  (vel_turn m))
