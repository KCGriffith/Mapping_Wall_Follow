...
(cl:defmethod cl:initialize-instance :after ((m <RoombaSwitch>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RoombaSwitch)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name irobotcreate2-msg:<RoombaSwitch> is deprecated: use irobotcreate2-msg:RoombaSwitch instead.")))
